...
* **PASCAL_CASE** - ABAP component types serialized in PascalCase where the symbol "\_" is treated as a word separator (and removed from the resulting name).

...
```
The transformation above uses the built-in ID transformation, that produce "ABAP JSON" output. If you want to have your custom transformation rules you can use [this project](https://github.com/timostark/abap-json-serialization) to create an XSLT trnaformation for your data structure.
